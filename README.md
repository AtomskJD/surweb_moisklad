...
- [X] актуализация цен розницы и закупки на сайте при приёмке товара на Моемскладе
- [x] При изменении цены товара нужно ее изменить на сайте
- [ ] при создании товара в Моёмскладе - создавать товар на сайте (название, цена закуп, цена розница, *категория*)
